...
public class SearchViewFormatter {
    ...
    protected int mSearchCursorResource = 0;
    ...
    public SearchViewFormatter setSearchIconResource(int searchIconResource,
                                                     boolean inside,
                                                     boolean outside) {
    ...
    public SearchViewFormatter setSearchCursorResource(int searchCursorResource) {

        mSearchCursorResource = searchCursorResource;
        return this;
    }
        ...
        if (mSearchIconResource != 0) {
            ...
            if (mSearchIconInside) {
                ...
                if (mSearchHintTextResource != 0) {
                    mSearchHintText =
                            mResources.getString(mSearchHintTextResource);
                }

                SpannableStringBuilder hintBuilder =
